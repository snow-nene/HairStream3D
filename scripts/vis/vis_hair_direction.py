...
参考 ReChannel/scripts/vis/vis_hair_direction.py 的可视化方式。

Usage:
  python scripts/vis/vis_hair_direction.py
  python scripts/vis/vis_hair_direction.py --backbone hrnet --checkpoint checkpoints/pretrain/hrnet_w32/img2strand_hrnet_w32_epoch_10.pth
"""
import sys
import time
