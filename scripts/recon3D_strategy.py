...
Usage examples:
    ...
    CUDA_VISIBLE_DEVICES=0 python -m scripts.recon3D_strategy --recon_strategy neural

    # Run with Laplace PDE solver (no pretrained weights needed)
    CUDA_VISIBLE_DEVICES=0 python -m scripts.recon3D_strategy --recon_strategy laplace

    # Laplace with custom PDE resolution
    CUDA_VISIBLE_DEVICES=0 python -m scripts.recon3D_strategy \
