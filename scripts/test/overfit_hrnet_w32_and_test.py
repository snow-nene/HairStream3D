...
Usage:
    PYTHONPATH=. pixi run python scripts/test/overfit_hrnet_w32_and_test.py
    PYTHONPATH=. pixi run python scripts/test/overfit_hrnet_w32_and_test.py --overfit_epochs 2000
"""
import os
import sys
